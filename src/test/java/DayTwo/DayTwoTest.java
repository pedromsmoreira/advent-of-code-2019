...
import static org.junit.jupiter.api.Assertions.assertEquals;
        ...
        An Intcode program is a list of integers separated by commas (like 1,0,0,3,99). To run one,
         ...
         ncountering an unknown opcode means something went wrong.
        ...
        you first need to get the values at the input positions: position 9 contains 30,
...
class DayTwoTest {
    ...
    @ParameterizedTest
    @MethodSource("provideProgramInputsAndExpectedValue")
    void restoreState_givenAdditionInFirstPositionAndGivenInput_ShouldReturnExpectedOutput(int[] input, int[] expected){
        // Arrange
        var sut = new StateRestorer();

        // Act
        var state = sut.restore(input);
